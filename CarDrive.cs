...
public class CarDrive : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        //brake car
        if (Input.GetButton("Fire1") == true) //leftctrl, mouseleftbutton
        {
    ...
    private void GetTheWheels()
    {
        ...
        FL.visualwheel = GetChildByName(wheels, "FrontLeftWheel").transform;
        FR.visualwheel = GetChildByName(wheels, "FrontRightWheel").transform;
        BL.visualwheel = GetChildByName(wheels, "RearLeftWheel").transform;
        BR.visualwheel = GetChildByName(wheels, "RearRightWheel").transform;
